...
func routes(_ app: Application) throws {
    ...
    app.on(.POST, "run", body: .collect(maxSize: "10mb")) { (req) -> EventLoopFuture<ExecutionResponse> in
        ...
        let options = parameter.options ?? ((toolchainVersion == "nightly-master" || toolchainVersion == "nightly-main") ? "-Xfrontend -enable-experimental-concurrency -Xfrontend -enable-experimental-prespecialization" : "")
