      ...
      if (enabled) {
        ...
        if (statusContainer) {
          statusContainer.setAttribute(
            ...
            "<p class='p-0 m-0'><b>Language Server Status:</b></p><p class='p-0 m-0 text-end'>Ready&nbsp;<span class='fa-solid fa-circle-check fa-fw'></span></p>"
          );
        ...
        if (statusContainer) {
          statusContainer.setAttribute(
            "data-bs-original-title",
            "<p class='p-0 m-0'><b>Language Server Status:</b></p><p class='p-0 m-0 text-end'>Initializing...&nbsp;<span class='fa-solid fa-circle-notch fa-spin fa-fw'></span></p>"
          );
          const tooltip = Tooltip.getInstance(statusContainer);
          tooltip.hide();
        }
