...
cp swift-docker/5.4/_Packages/Package.swift swift-docker/5.4.1/_Packages/Package.swift

swift package --package-path swift-docker/5.4/_Packages/ dump-package > Resources/Views/Package.json
